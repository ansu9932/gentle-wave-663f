...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/gentle-wave-663f)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-wave-663f
```

A live public deployment of this template is available at [https://gentle-wave-663f.templates.workers.dev](https://gentle-wave-663f.templates.workers.dev)
